...
BLERemoteDescriptorPatched* BLERemoteCharacteristic::getDescriptor(const char* uuid) {
    return getDescriptor(BLEUUIDPatched(uuid));
}

BLERemoteDescriptorPatched* BLERemoteCharacteristic::getDescriptor(BLEUUIDPatched uuid) {
...
BLEUUIDPatched BLERemoteCharacteristic::getUUID() {
    return _uuid;
}
...
void BLERemoteCharacteristic::enableNotifyIndicate(bool notify) {
    BLERemoteDescriptorPatched* pdesc = getDescriptor("2902");
    if (pdesc == nullptr) {
...
BLERemoteCharacteristic::BLERemoteCharacteristic(BLEUUIDPatched uuid) {
    _uuid = uuid;
...
bool BLERemoteCharacteristic::addDescriptor(BLERemoteDescriptorPatched* newDesc) {
