...
BLEUUIDPatched::BLEUUIDPatched() {
}

BLEUUIDPatched::BLEUUIDPatched(const char* str) {
    char temp[] = {0, 0, 0};
...
BLEUUIDPatched::BLEUUIDPatched(uint8_t* data, uint8_t length) {
...
const uint8_t* BLEUUIDPatched::data() {
    return _data;
}

const uint8_t* BLEUUIDPatched::dataNative() {
    return _dataNative;
}

uint8_t BLEUUIDPatched::length() {
    return _length;
}

bool BLEUUIDPatched::operator ==(const BLEUUIDPatched &uuid) {
