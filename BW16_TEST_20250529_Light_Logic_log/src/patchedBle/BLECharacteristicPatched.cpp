...
BLECharacteristicPatched::BLECharacteristicPatched(BLEUUIDPatched uuid) {
    setUUID(uuid);
    _data_buf = (uint8_t*)malloc(_data_buf_len*sizeof(uint8_t));
}

BLECharacteristicPatched::BLECharacteristicPatched(const char* uuid) {
    setUUID(BLEUUIDPatched(uuid));
    _data_buf = (uint8_t*)malloc(_data_buf_len*sizeof(uint8_t));
}

BLECharacteristicPatched::~BLECharacteristicPatched() {
    free(_userDesc);
    free(_data_buf);
}
...
void BLECharacteristicPatched::setUUID(BLEUUIDPatched uuid) {
...
BLEUUIDPatched BLECharacteristicPatched::getUUID() {
    return _uuid;
}

void BLECharacteristicPatched::setBufferLen(uint16_t max_len) {
...
uint16_t BLECharacteristicPatched::getBufferLen() {
    return _data_buf_len;
}

void BLECharacteristicPatched::setReadProperty(bool value) {
    if (value) {
...
void BLECharacteristicPatched::setWriteProperty(bool value) {
    if (value) {
...
void BLECharacteristicPatched::setWriteNRProperty(bool value) {
    if (value) {
...
void BLECharacteristicPatched::setNotifyProperty(bool value) {
    if (value) {
...
void BLECharacteristicPatched::setIndicateProperty(bool value) {
    if (value) {
...
void BLECharacteristicPatched::setProperties(uint8_t value) {
    _char_properties = value;
}

uint8_t BLECharacteristicPatched::getProperties() {
    return _char_properties;
}


void BLECharacteristicPatched::setReadPermissions(uint32_t value) {
...
void BLECharacteristicPatched::setWritePermissions(uint32_t value) {
    // Check for valid read permission value
...
void BLECharacteristicPatched::setPermissions(uint32_t value) {
    uint32_t all_read_perms = (GATT_PERM_READ | GATT_PERM_READ_AUTHEN_REQ | GATT_PERM_READ_AUTHOR_REQ | GATT_PERM_READ_ENCRYPTED_REQ | GATT_PERM_READ_AUTHEN_SC_REQ);
    uint32_t all_write_perms = (GATT_PERM_WRITE | GATT_PERM_WRITE_AUTHEN_REQ | GATT_PERM_WRITE_AUTHOR_REQ | GATT_PERM_WRITE_ENCRYPTED_REQ | GATT_PERM_WRITE_AUTHEN_SC_REQ);
    _char_attr_read_permissions = value & all_read_perms;
    _char_attr_write_permissions = value & all_write_perms;
...
uint32_t BLECharacteristicPatched::getPermissions() {
    return (_char_attr_read_permissions & _char_attr_write_permissions);
}

//--------- Read Char Value --------//

String BLECharacteristicPatched::readString() {
    char datastring[_data_buf_len + 1] = {0};
    getData((uint8_t*)datastring, sizeof(datastring));
    return String(datastring);
}

uint8_t BLECharacteristicPatched::readData8() {
    uint8_t num = 0;
    getData(&num, sizeof(num));
    return num;
}

uint16_t BLECharacteristicPatched::readData16() {
    uint16_t num = 0;
    getData((uint8_t*) &num, sizeof(num));
    return num;
}

uint32_t BLECharacteristicPatched::readData32() {
    uint32_t num = 0;
    getData((uint8_t*) &num, sizeof(num));
    return num;
}
...
bool BLECharacteristicPatched::writeString(String str) {
    return writeString(str.c_str());
}

bool BLECharacteristicPatched::writeString(const char* str) {
    return setData((uint8_t*) str, strlen(str));
}

bool BLECharacteristicPatched::writeData8(uint8_t num) {
    return setData((uint8_t*) &num, sizeof(num));
}

bool BLECharacteristicPatched::writeData16(uint16_t num) {
    return setData((uint8_t*) &num, sizeof(num));
}

bool BLECharacteristicPatched::writeData32(uint32_t num) {
    return setData((uint8_t*) &num, sizeof(num));
}

bool BLECharacteristicPatched::writeData32(int num) {
    return setData((uint8_t*) &num, sizeof(num));
}

//--------- Modify Char Value ---------//

bool BLECharacteristicPatched::setData(uint8_t* data, uint16_t datalen) {
...
uint16_t BLECharacteristicPatched::getData(uint8_t* data, uint16_t datalen) {
    if (datalen > _data_buf_len) {
...
uint8_t* BLECharacteristicPatched::getDataBuff() {
    return _data_buf;
}

uint16_t BLECharacteristicPatched::getDataLen() {
    return _data_len;
}

void BLECharacteristicPatched::notify(uint8_t conn_id) {
...
void BLECharacteristicPatched::indicate(uint8_t conn_id) {
...
void BLECharacteristicPatched::setUserDescriptor(const char* description) {
...
void BLECharacteristicPatched::setFormatDescriptor(uint8_t format, uint8_t exponent, uint16_t unit, uint16_t description) {
...
void BLECharacteristicPatched::setReportRefDescriptor(uint8_t id, uint8_t type) {
    _includeReportRefDescriptor = 1;
    _reportDescID = id;
    _reportDescType = type;
}

uint8_t BLECharacteristicPatched::getReportRefID() {
    return _reportDescID;
}

uint8_t BLECharacteristicPatched::getReportRefType() {
    return _reportDescType;
}

//------------- Callbacks -------------//

void BLECharacteristicPatched::setReadCallback(void (*fCallback) (BLECharacteristicPatched* chr, uint8_t conn_id)) {
    _pReadCB = fCallback;
}

void BLECharacteristicPatched::setWriteCallback(void (*fCallback) (BLECharacteristicPatched* chr, uint8_t conn_id)) {
    _pWriteCB = fCallback;
}

void BLECharacteristicPatched::setCCCDCallback(void (*fCallback) (BLECharacteristicPatched* chr, uint8_t conn_id, uint16_t ccc_bits)) {
    _pCccdCB = fCallback;
}

//---------- Private Methods ----------//

uint8_t BLECharacteristicPatched::getHandleIndex() {
    if (_handle_index == 0) {
...
uint8_t BLECharacteristicPatched::getAttrCount() {
...
uint8_t BLECharacteristicPatched::generateCharacteristicAttrTable(T_ATTRIB_APPL* attr_tbl, uint8_t index) {
...
uint8_t BLECharacteristicPatched::generateAttrCharacteristicDeclaration(T_ATTRIB_APPL* attr_tbl, uint8_t index) {
...
#define GATT_PERM_READ_AUTHEN_GET_PATCHED(x)     (x & 0x02)
#define GATT_PERM_WRITE_AUTHEN_GET_PATCHED(x)    ((x >> 4) & 0x02)

// Generate required characteristic descriptor attributes
uint8_t BLECharacteristicPatched::generateAttrDescriptorDeclaration(T_ATTRIB_APPL* attr_tbl, uint8_t index) {
    ...
    if (GATT_PERM_READ_AUTHEN_GET_PATCHED(_char_attr_read_permissions) || GATT_PERM_WRITE_AUTHEN_GET_PATCHED(_char_attr_write_permissions)) {
...
T_APP_RESULT BLECharacteristicPatched::charAttrReadCallbackDefault(uint8_t conn_id, T_SERVER_ID service_id, uint16_t attrib_index,
...
T_APP_RESULT BLECharacteristicPatched::charAttrWriteCallbackDefault(uint8_t conn_id, T_SERVER_ID service_id, uint16_t attrib_index,
...
void BLECharacteristicPatched::charCccdUpdateCallbackDefault(uint8_t conn_id, T_SERVER_ID service_id, uint16_t attrib_index, uint16_t ccc_bits) {
