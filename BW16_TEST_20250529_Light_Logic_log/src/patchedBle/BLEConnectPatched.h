#ifndef _BLE_CONN_PATCHED_H_
#define _BLE_CONN_PATCHED_H_
...
class BLEConnectPatched {
    public:
        ...
        bool connect(BLEAdvertDataPatched targetDevice, uint16_t scanTimeout);
        bool connect(BLEAddrPatched destAddr, T_GAP_REMOTE_ADDR_TYPE destAddrType, uint16_t scanTimeout);
        ...
        int8_t getConnId(BLEAdvertDataPatched targetDevice);
