#ifndef _BLE_CLIENT_PATCHED_H_
#define _BLE_CLIENT_PATCHED_H_

#include <Arduino.h>
#include "BLEUUIDPatched.h"
#include "BLERemoteServicePatched.h"
...
class BLEClientPatched {
    public:
        ...
        BLERemoteService* getService(BLEUUIDPatched uuid);
        uint8_t getConnId();
        T_CLIENT_ID getClientId();

        void setDisconnectCallback(void (*fCallback) (BLEClientPatched* client));
    ...
    private:
        ...
        friend class BLERemoteServicePatched;
        ...
        void (*_pDiscCB)(BLEClientPatched*) = nullptr;
};
