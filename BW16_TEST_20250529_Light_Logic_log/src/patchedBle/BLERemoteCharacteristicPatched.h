#ifndef _BLE_REMOTECHARACTERISTIC_PATCHED_H_
#define _BLE_REMOTECHARACTERISTIC_PATCHED_H_
...
class BLERemoteCharacteristic {
    public:
        //------------- Configure -------------//
        BLERemoteDescriptorPatched* getDescriptor(const char* uuid);
        BLERemoteDescriptorPatched* getDescriptor(BLEUUIDPatched uuid);
    ...
    private:
        BLERemoteCharacteristic(BLEUUIDPatched uuid);
        ~BLERemoteCharacteristic();

        bool addDescriptor(BLERemoteDescriptorPatched* newDesc);
        ...
        BLERemoteDescriptorPatched* _descriptorPtrList[MAX_NUM_DESC] = {0};
