...
BLERemoteService::BLERemoteService(BLEUUIDPatched uuid) {
    _uuid = uuid;
}
...
BLEUUIDPatched BLERemoteService::getUUID() {
    return _uuid;
}

BLERemoteCharacteristic* BLERemoteService::getCharacteristic(const char* uuid) {
    return getCharacteristic(BLEUUIDPatched(uuid));
}

BLERemoteCharacteristic* BLERemoteService::getCharacteristic(BLEUUIDPatched uuid) {
