#ifndef _BLE_ADVERT_PATCHED_H_
#define _BLE_ADVERT_PATCHED_H_
...
class BLEAdvertPatched {
    public:
        ...
        void setAdvData(BLEAdvertDataPatched adData);
        void setScanRspData(BLEAdvertDataPatched adData);          // Note: scan response data is not sent if advertising type is ADV_NONCONN_IND
