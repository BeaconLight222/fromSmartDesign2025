#ifndef _BLE_REMOTEDESCRIPTOR_PATCHED_H_
#define _BLE_REMOTEDESCRIPTOR_PATCHED_H_
...
class BLERemoteDescriptorPatched {
    public:
        //------------- Configure -------------//
    ...
    private:
        BLERemoteDescriptorPatched(BLEUUIDPatched uuid);
        ~BLERemoteDescriptorPatched();
