...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint a1e9mdr77wm319-ats.iot.us-east-1.amazonaws.com --ca_file root-CA.crt --cert amebaDevBoard.cert.pem --key amebaDevBoard.private.key --client_id basicPubSub --topic sdk/t2est/python --count 0