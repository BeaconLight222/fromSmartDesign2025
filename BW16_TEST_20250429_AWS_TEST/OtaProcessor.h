...
// def process_OTA_verify_signature(signatureBase64):
    ...
    // bool verifyOTASignature(const uint8_t* data, size_t length, const char* signature);
    // void processOTADataChunk(const uint8_t* data, size_t length);
    // void finalizeOTA();
