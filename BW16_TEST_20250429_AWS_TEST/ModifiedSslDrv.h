#ifndef MODIFIED_SSL_DRV_H
#define MODIFIED_SSL_DRV_H
...
class ModifiedSSLDrv {
public:
    int startClient(sslclient_context *ssl_client, uint32_t ipAddress, uint32_t port, void* rootCABuff, void* cli_cert, unsigned char* cli_key, char* SNI_hostname);
