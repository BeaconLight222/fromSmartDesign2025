...
uint32_t ota_get_cur_PhyAddr(void) {
...
void setup() {
  ...
  uint32_t ota_address = ota_get_cur_PhyAddr();
  Serial.print("Current OTA addr: ");
  Serial.println(ota_address, HEX);
  int otaIndex = 0;
  if (ota_address >= 0x8206000) {
    otaIndex = 1;
  }
  Serial.print("Current OTA index: ");
  Serial.println(otaIndex);
